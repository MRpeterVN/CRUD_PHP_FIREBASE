                        ...
                        <li class="l-section section section--is-active">
                            <div class="intro">
                                ...
                                <div class="intro--options">
                                    <a href="#0">
                                        <h3>Nghe và trải Nghiệm</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do.</p>
                                    </a>
                                    <a href="#0">
                                        <h3>Âm nhác &amp; Công Nghệ</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do.</p>
                                    </a>
                                    <a href="#0">
                                        <h3>Vượt mọi giới hạn</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do.</p>
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <ul class="slider">
                                        <li class="slider--item slider--item-left">
                                            <a href="#0">
                                                ...
                                                <p class="slider--item-title">Nghe và trải Nghiệm</p>
                                        ...
                                        <li class="slider--item slider--item-center">
                                            <a href="#0">
                                                ...
                                                <p class="slider--item-title">Âm nhác &amp; Công Nghệ</p>
                                                <p class="slider--item-description">Lorem ipsum dolor sit amet,
                                                    consectetur adipisicing elit sed do.</p>
                                            </a>
                                        </li>
                                        <li class="slider--item slider--item-right">
                                            <a href="#0">
                                                ...
                                                <p class="slider--item-title">Vượt mọi giới hạn</p>
                                                <p class="slider--item-description">Lorem ipsum dolor sit amet,
                                                    consectetur adipisicing elit sed do.</p>
                                            </a>
                                        </li>
                                ...
                                <div class="contact--lockup">
                                    <div class="modal">
                                        <div class="modal--information">
                                            <p>195Trần Đại Nghĩa/p>
                                                <a href="tel:+84337225363">0337225363</a>
                                        </div>
                                        <ul class="modal--options">
                                            <li><a href="#0">Facebook</a></li>
                                            <li><a href="#0">Telegram</a></li>
                                            <li><a href="mailto:anlt.21ir@vku.udn.vn">Mail To</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="l-section section">
                            <div class="hire">
                                ...
                                <form action="login.php" method="POST">
                                    ...
                                    <input style="color:black;" type="text" name="username" id="username" required><br>
                                    <label for="password">Password:</label>
                                    <input style="color:black;" type="password" name="password" id="password"
                                        required><br>
                                    <button style="color:black;" type="submit" name="login">Log In</button>
                                </form>
